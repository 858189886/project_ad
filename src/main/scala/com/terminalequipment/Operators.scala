...
object Operators {
    def main(args: Array[String]): Unit = {
        ...
        /**
          ...
          *
          */
        val operatorsNameAndList: RDD[(String, List[Double])] = MakeTupeRddUtil.getTupes(logsDF,"ispname")
        ...
        val rowRDD: RDD[OperatorsNameInfo] = ansRDD.map(x => {
            OperatorsNameInfo(x._1, x._2(0).toInt, x._2(1) toInt, x._2(2).toInt, x._2(3).toInt, x._2(4).toInt, x._2(5).toInt, x._2(6).toInt, x._2(7), x._2(8))
        })
...
case class OperatorsNameInfo(operatorsName: String, originalRequest: Int, validRequest: Int, advertisingRequest: Int, showAmount: Int, clinkAmount: Int, parAmount: Int, accAmount: Int, endOne: Double, endTwo: Double)
