...
object NetworkingMode {
    def main(args: Array[String]): Unit = {
        ...
        val ansRDD: RDD[(String, List[Double])] = MakeAnsUtil.getAns(networkmannerNameAndList)
        ...
        ansRDD.foreachPartition(t => {
            ...
            t.foreach(x => {
                val sql: String = s"insert into NetworkMannerNameInfo values('${x._1}',${x._2(0).toInt},${x._2(1).toInt}, ${x._2(2).toInt}, ${x._2(3).toInt}, ${x._2(4).toInt}, ${x._2(5).toInt}, ${x._2(6).toInt}, ${x._2(7)}, ${x._2(8)})"
        ...
        //这一步是封装成一个DF
        val rowRDD: RDD[NetworkMannerNameInfo] = ansRDD.map(x => {
            NetworkMannerNameInfo(x._1, x._2(0).toInt, x._2(1) toInt, x._2(2).toInt, x._2(3).toInt, x._2(4).toInt, x._2(5).toInt, x._2(6).toInt, x._2(7), x._2(8))
        })
...
case class NetworkMannerNameInfo(networkmannerName: String, originalRequest: Int, validRequest: Int, advertisingRequest: Int, showAmount: Int, clinkAmount: Int, parAmount: Int, accAmount: Int, endOne: Double, endTwo: Double)